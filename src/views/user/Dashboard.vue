                ...
                <Card>
                    <template #content>
                        <div class="flex flex-row gap-5 justify-content-center">
                            <div class="flex flex-row gap-3 px-5 py-1 counter counter-green align-items-center">
                                <div class="small-text">תהליכים<br> פתוחים</div>
                                <div class="big-text green">145</div>
                            </div>
                            <div class="flex flex-row gap-3 px-5 py-1 counter counter-red align-items-center">
                                <div class="small-text">תהליכים <br> חורגים</div>
                                <div class="big-text red">45</div>
                            </div>
                            <div class="flex flex-row gap-3 px-4 py-2 time-info justify-content-between">
                        ...
                        <div class="flex flex-column gap-3">
                            <div class="flex flex-row justify-content-between">
                                <div class="flex flex-row">
                                    ...
                                    <WMButton class="m-1 col-6" name="assign-white" icon="assign"
                            ...
                            <DataTable v-model:selection="selectedCustomers" :value="customers" dataKey="id"
                                       tableStyle="max-width: 30rem"
                                       class="p-datatable-sm" scrollable scrollHeight="flex" paginator :rows="5">
                                <Column style="width: 40px" selectionMode="multiple"></Column>

                                <Column field="telephone" header="מס’ לקוח">
                                    <template #body="slotProps">
                                        <router-link to="/foo" class="vertical-align-middle">{{ slotProps.data.telephone
                                        }}</router-link>
                                    </template>
                                </Column>
                                ...
                                <Column field="selected_product" header="איש קשר ראשי">
                                    <template #body="slotProps">
                                        <router-link to="/foo" class="vertical-align-middle">{{
                                            slotProps.data.selected_product }}</router-link>
                                    </template>
                                </Column>
            ...
            <div class="flex flex-column gap-5 card-container">
                <Card>
                    <template #content>
                        <div class="flex flex-row gap-5 justify-content-center">
                            <div class="flex flex-row gap-3 px-5 py-1 counter counter-green align-items-center">
                                <div class="small-text">משימות<br> פתוחים</div>
                                <div class="big-text green">145</div>
                            </div>
                            <div class="flex flex-row gap-3 px-5 py-1 counter counter-red align-items-center">
                                <div class="small-text">משימות <br> חורגים</div>
                                <div class="big-text red">45</div>
                            </div>
                        </div>
                    </template>
...
const setChartData = () => {
    ...
    return {
        ...
        datasets: [
            {
                data: [17, 33, 50],
                backgroundColor: [documentStyle.getPropertyValue('--red-400'), documentStyle.getPropertyValue('--yellow-400'), documentStyle.getPropertyValue('--teal-500')],
                hoverBackgroundColor: [documentStyle.getPropertyValue('--red-500'), documentStyle.getPropertyValue('--yellow-500'), documentStyle.getPropertyValue('--teal-600')]
            }
        ]
    };
};
