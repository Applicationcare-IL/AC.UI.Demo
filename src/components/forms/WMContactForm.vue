  ...
  <div class="wm-form-container flex flex-auto flex-column overflow-auto">
    <div class="contact-data flex flex-auto flex-column gap-5 mb-5">
      ...
      <div class="wm-form-row">
        <WMInput name="owner" type="info" :highlighted="true" :label="$t('contact.in-charge') + ':'"
      ...
      <div class="wm-form-row align-items-end gap-2">
        <WMInputSearch name="customer" :placeholder="$t('contact.select_customer')" :required="true" type="input-search" :label="$t('contact.customer') + ':'" :multiple="true" width="248" :options="customers" :highlighted="true" />
    ...
    <div class="contact-data flex flex-auto flex-column gap-5 mb-5">
      ...
      <div class="wm-form-row gap-5">
        <WMInputSearch name="city" :highlighted="true" :label="$t('contact.city') + ':'" :options="customers" width="152" :placeholder="$t('contact.select_city')" />
        <WMInputSearch name="street" :highlighted="true" :label="$t('contact.street') + ':'" :options="customers" width="152" :placeholder="$t('contact.select_street')" />
      </div>
      <div class="wm-form-row gap-5">
        ...
        <WMInput name="entrance" type="input-select" :highlighted="true" :label="$t('contact.entrance') + ':'" :options="alphabetWithDash" width="48" />
      </div>
