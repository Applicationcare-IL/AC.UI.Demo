<template>
  ...
  <div class="wm-detail-form-container flex flex-column overflow-auto gap-5">
    ...
    <Accordion>
      <AccordionTab :header="$t('budget.payments')"> PAYMENTS </AccordionTab>
    </Accordion>
...
const { getProjectBudget } = useBudgets();
