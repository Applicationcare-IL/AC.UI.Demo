      ...
      <div class="wm-form-row align-items-baseline">
        <div class="flex flex-column gap-5">
          <div class="wm-form-row gap-5 align-items-baseline">
            ...
            />
            <WMInput
              name="preview_cancellation_type"
              type="info"
              :highlighted="true"
              size="sm"
        ...
        <div class="wm-form-row gap-5">
          <div class="wm-input flex flex-column w-full">
            ...
            <span
              class="w-full text-overflow-ellipsis overflow-hidden bg-gray-100 p-2 border-round-lg"
            >
              {{ product.description }}
            </span>
          </div>
