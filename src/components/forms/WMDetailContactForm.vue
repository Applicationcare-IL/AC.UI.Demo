                ...
                <div class="wm-form-row gap-5">
                  <div class="wm-form-row gap-4">
                    <WMInput name="status" :highlighted="true" type="input-select" :label="$t('status') + ':'"
                             :options="statusOptions" :selectedOption="statusOptions.find(status => status.value===contact.status)" />

                    <WMInput name="gender" :highlighted="true" type="input-select" :label="$t('gender') + ':'"
                             :options="genders" :selectedOption="genders.find(gender => gender.value===contact.gender)" :placeholder="$t('select', ['gender'])" width="130" />
                  </div>
                </div>
              </div>
            </template>
              ...
              <div class="flex flex-auto flex-column gap-5">
                <div class="wm-form-row gap-5">
                  <div class="wm-form-row gap-5">
                    ...
                    <WMInput name="landline" type="input-text" :label="$t('landline') + ':'" width="88" :value="contact.landline"/>
                    <WMInput name="fax" type="input-text" :label="$t('fax') + ':'" width="88" />
                  </div>
                </div>
                <div class="wm-form-row gap-5">
                  <WMInput name="facebook" type="input-text" :label="$t('facebook') + ':'" width="88" />
                  <WMInput name="email" :required="true" type="input-text" :label="$t('email') + ':'" width="240" :value="contact.email"/>
