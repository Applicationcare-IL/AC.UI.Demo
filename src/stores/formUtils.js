...
const URLRegex = /^(https?:\/\/)?(www\.)?([a-zA-Z0-9-]+\.){1,}[a-zA-Z0-9-]+(\/.*)?$/;
  ...
  getters: {
    ...
    getNewSalesFormValidationSchema: () => {
      return yup.object({
        ...
        // legal_adviser: yup.object().optional(),
        // sales_manager: yup.object().optional(),
        // projects_managers: yup.object().optional(),
        // customer_consultant: yup.object().optional(),
        // information_technology: yup.object().optional(),
        // business_manager: yup.object().optional(),
        // decision_maker: yup.object().optional(),
        // budgeting_factor: yup.object().optional(),
        // budget: yup.number(),
      });
    },
