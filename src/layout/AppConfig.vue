...
<template>
    ...
    <Sidebar v-model:visible="visible" position="right" :transitionOptions="'.3s cubic-bezier(0, 0, 0.2, 1)'"
        ...
        <div class="flex flex-row gap-2">
            <i-button @click="$i18n.locale = 'en'; layoutConfig.isRTL.value = false"> <span class="flag flag-gb"></span></i-button>
            <i-button @click="$i18n.locale = 'he'; layoutConfig.isRTL.value = true"> <span class="flag flag-il"></span></i-button>
        </div>
        <h5>Scale</h5>
        ...
        <template v-if="!simple">
            ...
            <h5>RTL</h5>
            <InputSwitch v-model="layoutConfig.isRTL.value"></InputSwitch>
        </template>
